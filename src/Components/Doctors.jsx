...
const Doctors = () => {
  const data = [
    {
      img: doc1,
      name: "Dr. Saurabh Saini",
      specialties: "Ophthalmologist",
    },
    {
      img: doc2,
      name: "Dr. Shareya Bist",
    ...
    {
      img: doc4,
      name: "Dr. Meena Gandhi",
      specialties: "Neurologist",
    },
    {
      img: doc5,
      name: "Dr. Yash Bhardwaj",
      specialties: "Dermatologist",
    },
    {
      img: doc6,
      name: "Dr. Neetarpal Rawal",
      specialties: "Orthopadic Surgeon",
    },
  ];
    ...
    <div className=" min-h-screen flex flex-col justify-center lg:px-32 px-5 pt-16">
      <div className=" flex flex-col items-center justify-between mb-10 lg:mb-0">
        <div>
          ...
          Meet our skilled doctors dedicated to providing exceptional care and personalized treatment for your health.
          </p>
        </div>
